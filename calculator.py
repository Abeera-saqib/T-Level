...
class Calculator:
    def __init__(self, root):
        ...
        self.MainFrame1 = Frame(self.root, bd=20, relief=RIDGE, width=605, bg="#7dd3fc")  # Corrected hex color
        self.MainFrame1.grid()

        self.MainFrame2 = Frame(self.MainFrame1, bd=20, relief=RIDGE, width=605, height=670, bg="powder blue")  # Fixed "Frame" and "self"
        ...
        self.create_button("1", 4, 0)  # Fixed method name
    ...
    def button_click(self, text):
        if text == "←":
            ...
            self.input_value = str(-float(self.input_value)) if self.input_value else "0"
        else:
